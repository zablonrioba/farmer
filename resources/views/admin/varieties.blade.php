...
<section class="content-header">
  ...
  <div class="margin">
    {{-- top bar start --}}
    <div class="alert alert-success text-center" role="alert"><span>Waddup Admin, Add Product Varieties</span>
    ...
    <div class="row">
                       ...
                       @foreach($varieties as $category)
                        ...
                        <td><span class="badge bg-green">{{$category->status}}</span></td>
                            <td>
                                ...
                                <a class="btn btn-primary" type="button" href="/varieties/{{$category->id}}/edit"><i class="fa fa-edit"></i> Edit</a>
                                    @else
                            ...
                            <form id="c{{$category->id}}" class="pull-right" method="POST" action="/varieties/{{$category->id}} " style="display:none">
                                    {{ csrf_field() }}
        ...
        <div class="col-md-6">
            ...
            <form method="post" action="/varieties">
                {{ csrf_field() }}
